...
response.write("<span color = 'red'></span>");
response.write("<form action ='addStudent' onsubmit ='return validateForm(this)'>");
response.write(" <table>");
response.write("    <tr>");
response.write("        <td>Roll Number </td>");
response.write("        <td><input type = 'text' id ='rollNumber' name ='rollNumber' maxlength='10' size ='11' value = ''>");
...
response.write("        <td><input type = 'text' id ='name' name ='name' maxlength='25' size ='26' value = ''>");
