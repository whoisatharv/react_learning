...
exports.processRequest=function(request,response)
{
    ...
    //searching the student in the list , checks if the roll number exists, if a match is found it stores the students name and sets found=true.
    var i;
    var found =false;
    var name="";
    ...
    //if student  not  found,provide a form and a button to return to the student listing page
    if(!found)
    {
 ...
 //handling case  student found
    ...
    response.write("   <title> College Message board </title>");
    response.write("   <meta charset = 'utf-8'></head> ");
//checks if the name is empty  displays an error message if the validation fails
...
//generating edit form , dispalys the student roll number as read only
    response.write("<body>");
    response.write("<h1> Administrator </h1>");
    response.write("<table width ='100%' border = '0'>");
    response.write("   <tr>");
    ...
    response.write("</tr>");
    //creates an input field with prefield with the students name
    response.write("<tr>");
